...
def build_net(input,binary,stochastic=False,H=1.0,W_LR_scale="Glorot",activation=binary_net.binary_tanh_unit,epsilon=1e-4,alpha=.1,patch_size=32, num_filters=256, num_classes=10):

    cnn = lasagne.layers.InputLayer(
            shape=(None, 3, patch_size, patch_size),
            input_var=input)
#1        
